				...
				<div class="sparkline8-list shadow-reset">
					<div class="sparkline8-hd">
						<div class="main-sparkline8-hd">
							<h1>Tambah Kurikulum Berdasarkan Jurusan!</h1>
							<div class="sparkline8-outline-icon">
								<span title="Refresh"><a href="<?php echo base_url('admin/Kurikulum'); ?>" class="btn-sm btn-warning"><i class="fa fa-refresh"></i></a>
								</span>
								...
								<tbody>
									...
									foreach ($jurusan as $row) : ?>
										<tr>
											...
											<td>
												<a class="btn-sm btn-primary" href="<?php echo base_url('admin/Kurikulum/index_kurikulum/' . $row->kd_jurusan . '/'); ?>"><i class="fa fa-calendar"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
