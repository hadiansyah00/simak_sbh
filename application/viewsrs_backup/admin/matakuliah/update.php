										...
										<?php foreach ($matakuliah as $mk) : ?>
											<form class="form-horizontal form" method="post" action="<?php echo base_url('admin/Matakuliah/updateAksi/' . $mk->kd_jurusan); ?>">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="kd_mk"  value="<?php echo $mk->kd_mk; ?>" class="form-control">
													</div>
												</div>
													...
													<div class="col-sm-8">
														<select name="jurusan" id="jurusan" class="form-control">
															...
															foreach ($jurusan as $row) : ?>
																<?php $jrs = $row->jurusan; ?>
																<option value="<?php echo $row->kd_jurusan; ?>" <?php echo ($jrs == $row->jurusan) ? "selected" : "" ?>><?php echo $row->jurusan; ?></option>
															<?php endforeach; ?>
														</select>
													</div>
												</div>
