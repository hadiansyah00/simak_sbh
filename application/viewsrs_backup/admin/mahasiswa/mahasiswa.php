									...
									foreach ($mahasiswa as $row) { ?>
										...
										<tr>
											...
											<td><?php echo $row->kelas; ?></td>
												<td> <a  class="link"href="<?php echo base_url('admin/Mahasiswa/upStatus/' . $row->id_mahasiswa); ?>"> <?php echo $row->status_mhs; ?></a></a></td>
												<td><?php echo $row->tahun_masuk; ?></td>
												<td > <a  class="link"href="<?php echo base_url('admin/Mahasiswa/updateDospem/' . $row->id_mahasiswa); ?>"><?php echo $row->nama_dosen; ?></a></td>
