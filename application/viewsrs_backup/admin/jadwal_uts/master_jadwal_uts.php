											...
											<tr>
												...
												if ($btn['hide_btn_del'] == 0) {
													...
													<td>
														...
														<a class="green" href="<?php echo base_url('admin/Jadwaluts/update/' . $row->id_jadwal); ?>">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header header-color-modal bg-color-1">
				<h4 class="modal-title">Form Tambah Jadwal Uts</h4>
					...
					<div class="col-lg-12">
						<div class="all-form-element-inner">
							...
							<?php foreach ($detil as $row) { ?>
								...
								<!--	<div class="row">-->
								<!--		<div class="col-lg-4">-->
								<!--			<label class="login2 pull-left pull-left-pro">Hari UTS</label>-->
								<!--		</div>-->
								<!--		<div class="col-lg-8">-->
									...
									<div class="row">
										...
										<div class="col-lg-8">
											<select name="ruangan" class="form-control">
												...
												<option value="Ruang 1.2"> Ruang 1.2 </option>
												<option value="Ruang 1.3"> Ruang 1.3</option>
												<option value="Ruang 1.4 "> Ruang 1.4 </option>
												<option value="Ruang 1.5 "> Ruang 1.5 </option>
												<option value="Ruang 1.6"> Ruang 1.6 </option>
													<option value="Ruang 1.1 & Ruang 1.4"> Ruang 1.1 / Ruang 1.4 </option>
