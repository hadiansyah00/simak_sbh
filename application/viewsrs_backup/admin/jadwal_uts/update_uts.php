                                ...
                                <div class="col-lg-12">
                                    <div class="all-form-element-inner">
                                        ...
                                        <?php foreach ($jadwal as $row) : ?>
                                            ...
                                            <form action="<?php echo base_url('admin/Jadwaluts/update'); ?>" method="post">
                                                ...
                                                <div class="form-group-inner">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select name="ruangan" class="form-control">
                                                            <option <?php echo ($r == ' Ruang 1.1') ? "selected" : "" ?>> 1.1 </option>
                                                            <option <?php echo ($r == ' Ruang 1.2') ? "selected" : "" ?>> 1.2 </option>
                                                            <option <?php echo ($r == ' Ruang 1.3') ? "selected" : "" ?>> 1.3 </option>
                                                            <option <?php echo ($r == ' Ruang 1.4') ? "selected" : "" ?>> 1.4 </option>
                                                            <option <?php echo ($r == ' Ruang 1.1 & Ruang 1.4') ? "selected" : "" ?>> 1.1 & 1.4 </option>
