...
<body>
	<div class="container-fluid">
		<div class="row bg-login">
			<div class="col-md-7 col-lg-7 col-sm-5 image-wrapper bg-cover d-flex align-items-center justify-content-center" data-image-src="<?php echo base_url(); ?>assets/login-mhs/img/bg-login.png" style="background-image: url(<?php echo base_url(); ?>assets/login-mhs/img/bg-login.png)">
					...
					<div class="login-form ">
						<div class="row">
							...
							<div class="col-md-12 col-lg-10 col-xs-12">
								...
								<h1 class="font-32px font-weight-bold text-blue mb-5 text-center"> Login Admin <br>SIAKAD | SBH</h1>
							</div>
						</div>
						<div class="row ">
							<div class="col-md-12 col-lg-10 col-xs-12">
								<?php echo $this->session->flashdata('pesan'); ?>
								<form method="post" action="<?php echo base_url(); ?>auth/bauk_login" onsubmit="return cekform();">
									<div class="controls">
										<div class="row">
											<div class="col-12">
