		...
		<div class="d-flex flex-column">
			...
			<nav class="nav-menu">
				<ul>
					...
					<li><a href="<?php echo base_url('mhs/Khs'); ?>"><i class="bx bx-book-content"></i> Kartu Hasil Studi(KHS)</a></li>
					<li><a href="<?php echo base_url('mhs/jadwal'); ?>"><i class="bx bx-file"></i> Jadwal Kuliah</a></li>
					<li>
						<?php

						if ($mhs['status_uts'] == 0) { ?>
							<a href="" data-toggle="modal" data-target="#exampleModalUTS"><i class="bx bx-file-blank"></i> <span>Jadwal & Nilai UTS</span></a>
						<?php } else { ?>
							<a href="<?php echo base_url('mhs/jadwaluts'); ?>"><i class="bx bx-file"></i> <span>Jadwal & Nilai UTS</span></a>
						<?php } ?>
					</li>
					<li>
						<?php
						...
						if ($mhs['status_uas'] == 0) { ?>
							<a href="" data-toggle="modal" data-target="#exampleModalUAS"><i class="bx bx-file"></i> <span>Jadwal & Nilai UAS </span></a>
						<?php } else { ?>
							<a href="<?php echo base_url('mhs/jadwaluas'); ?>"><i class="bx bx-file-blank"></i> <span>Jadwal & Nilai UAS </span></a>
						<?php } ?>
					</li>
