...
<div class="container">
	...
	<br>
	<p> <a href="<?php echo base_url('mhs/Jadwaluas/print_uas_kelas_pagi/' . $mhs['id_mahasiswa']); ?>" target="_blank" class="btn btn-sm btn-success"><i class="icofont-print"></i> Print UAS</a>
	</p>
