...
<div class="container">
	...
	<a href="<?php echo base_url('mhs/Jadwaluts/print_kelas_pagi/' . $mhs['id_mahasiswa']); ?>" target="_blank" class="btn btn-sm btn-success"><i class="icofont-print"></i> Print UTS</a>
